...
# Load documentation
cat src/m4queue.m4 | docgen-extractor-m4 | docgen-compiler-m4 | docgen-backend-manpage --section 'cware' --title 'C-Ware Manuals' --date "`date +'%b %d, %Y'`"
cat examples/tree/tree.m4c | docgen-extractor-m4 | docgen-compiler-m4 | docgen-backend-manpage --section 'cware' --title 'C-Ware Manuals' --date "`date +'%b %d, %Y'`"
cat pages/m4queue-intro.doc | docgen-extractor-c | docgen-compiler-c | docgen-backend-manpage --section 'cware' --title 'C-Ware Manuals' --date "`date +'%b %d, %Y'`"
